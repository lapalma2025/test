...
function evalRko(
  ...
  // RKO wycofane od 1.10.2024 — nie przysługuje na dzieci urodzone od tej daty.
  // Zastąpione przez "Aktywnie w domu" (500 zł × 24 mies., wiek dziecka 12–35 mies.).
  return {
    benefitId: benefit.id,
    benefit,
    eligibility: 'na',
    amountPln: null,
    amountDisplay: 'niedostępne',
    deadlineAt: null,
    deadlineDescription: '',
    channel: benefit.channel,
    reasoning: 'RKO wycofane od 1.10.2024. Dla dzieci urodzonych od tej daty odpowiednikiem jest "Aktywnie w domu" (500 zł/mies. od 12. do 35. miesiąca).',
    totalProjectedPln: 0,
  };
}
...
/* ============================================================================
 * Test scenariusze są w __tests__/eligibility-engine.test.ts (Jest)
 * ========================================================================== */
