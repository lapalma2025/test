...
(function () {
  ...
  function initialState() {
    ...
    const tabs = ["trasa", "szkoly", "pieniadze", "lista", "profil"];
    ...
    if (st.view === "login") {
      ...
      if (top) {
        if (top.type === "benefit") body = h(BenefitDetail, { id: top.id, onBack: back });
          ...
          const TOOL = { week: WeekScreen, duedate: DueDateCalc, kick: KickCounter, contraction: ContractionTimer, tests: TestJournal, feeding: FeedingTracker, vaccine: VaccineTracker, album: PhotoAlbum, notes: Notes };
