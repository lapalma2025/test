...
const STATUS_LABELS: Record<StatusType, { label: string; color: string; bg: string }> = {
  normal: { label: 'w normie', color: colors.evergreen.DEFAULT, bg: colors.sage.soft },
  abnormal: { label: 'poza normą', color: '#9C4F33', bg: colors.terracotta.soft },
  unknown: { label: 'brak oceny', color: colors.ink.faint, bg: colors.line.DEFAULT },
};
            ...
            <>
              ...
              <View style={{
                ...
                <View style={{ flex: 1, alignItems: 'center' }}>
                  ...
                  <Text style={{ fontSize: 11.5, color: colors.ink.soft, marginTop: 2 }}>wyników</Text>
                </View>
                ...
                <View style={{ flex: 1, alignItems: 'center' }}>
                  ...
                  <Text style={{ fontSize: 11.5, color: colors.ink.soft, marginTop: 2 }}>w normie</Text>
                </View>
                <View style={{ width: 0.5, alignSelf: 'stretch', backgroundColor: colors.line.DEFAULT, marginVertical: 4 }} />
                <View style={{ flex: 1, alignItems: 'center' }}>
                  ...
                  <Text style={{ fontSize: 11.5, color: colors.ink.soft, marginTop: 2 }}>do uwagi</Text>
                </View>
              </View>
            ...
            <SafeAreaView style={{ flex: 1 }} edges={['top', 'bottom']}>
              <View style={{
                ...
                <Text style={{ flex: 1, textAlign: 'center', fontSize: 15, fontFamily: 'Geist_500Medium', color: colors.ink.DEFAULT }}>
                  {editId ? 'Edytuj wynik' : 'Nowy wynik'}
                </Text>
              ...
              <ScrollView contentContainerStyle={{ padding: 20, gap: 16 }} keyboardShouldPersistTaps="handled">
                <View>
                  <Text style={labelStyle}>Nazwa badania *</Text>
                  <TextInput
                    value={form.name}
                ...
                <View style={{ flexDirection: 'row', gap: 12 }}>
                  <View style={{ flex: 2 }}>
                    <Text style={labelStyle}>Wartość *</Text>
                    <TextInput
                      value={form.value}
                  ...
                  <View style={{ flex: 1 }}>
                    <Text style={labelStyle}>Jednostka</Text>
                    <TextInput
                      value={form.unit}
                ...
                <View>
                  <Text style={labelStyle}>Zakres normy</Text>
                  <TextInput
                ...
                <View>
                  <Text style={labelStyle}>Trymestr</Text>
                  <View style={{ flexDirection: 'row', gap: 8, flexWrap: 'wrap' }}>
                    {([null, 1, 2, 3] as TrimesterType[]).map((t) => (
                      <Pressable
                        key={String(t)}
                        onPress={() => setF('trimester', t)}
                        style={{
                          paddingHorizontal: 16, paddingVertical: 8, borderRadius: 99,
                          backgroundColor: form.trimester === t ? colors.evergreen.DEFAULT : colors.surface.DEFAULT,
                          borderWidth: 1, borderColor: form.trimester === t ? colors.evergreen.DEFAULT : colors.line.DEFAULT,
                        }}
                      >
                        <Text style={{
                          fontSize: 13, fontFamily: 'Geist_500Medium',
                          color: form.trimester === t ? colors.cream.DEFAULT : colors.ink.DEFAULT,
                        }}>
                          {t === null ? 'Brak' : `${t}. trymestr`}
                        </Text>
                      </Pressable>
                    ))}
                  </View>
                ...
                <View>
                  <Text style={labelStyle}>Ocena wyniku</Text>
                ...
                <View>
                  <Text style={labelStyle}>Notatka</Text>
                  <TextInput
                    value={form.note}
