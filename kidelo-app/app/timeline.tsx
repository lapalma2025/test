...
const FRUIT_KEYS: [string, string][] = [
  ...
  ['jagoda', '🫐'], ['malina', '🍓'], ['truskawka', '🍓'], ['wiśnia', '🍒'],
  ['czereśnia', '🍒'], ['fasolka', '🫘'], ['winogrono', '🍇'], ['kumkwat', '🍊'],
  ['figa', '🫐'], ['limonka', '🍋'], ['cytryna', '🍋'], ['jabłko', '🍎'],
  ['awokado', '🥑'], ['gruszka', '🍐'], ['papryka', '🫑'], ['mango', '🥭'],
  ['pomidor', '🍅'], ['banan', '🍌'], ['marchewka', '🥕'], ['papaja', '🌴'],
  ['kabaczek', '🥒'], ['ogórek', '🥒'], ['grejpfrut', '🍊'], ['kukurydza', '🌽'],
  ['kalafior', '🥦'], ['brokuł', '🥦'], ['sałata', '🥬'], ['bakłażan', '🍆'],
  ['dynia', '🎃'], ['kokos', '🥥'], ['kapusta', '🥬'], ['ananas', '🍍'],
  ['melon', '🍈'], ['arbuz', '🍉'],
];
